...
namespace gazebo {
class ForkLiftFreeBodyWorld: public WorldPlugin {
...
public:
	void Load(physics::WorldPtr _parent, sdf::ElementPtr /*_sdf*/) {
		...
		addModel("model://forklift_freebody", "forklift_freebody" , 0.0, 0.0, 0.0);
	}

};

GZ_REGISTER_WORLD_PLUGIN(ForkLiftFreeBodyWorld)
}
